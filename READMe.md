Please read the instructions in the `INSTRUCTIONS.md` file before starting the skill test.
...
- **Requirements**:
  ...
  - Integrate Web3 wallet connection in frontend (Add Connect wallet button to the existing "Sigin in" button)
